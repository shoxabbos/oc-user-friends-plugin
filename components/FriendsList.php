...
class FriendsList extends ComponentBase
{
    private $user;
    ...
    protected function prepareVars()
    {
        ...
        $this->page['friends'] = $this->friends = $this->loadFriendsList();
    }
    ...
    protected function loadFriendsList()
    {
        return Friend::where('user_id', $this->user->id)->get();
    } 
